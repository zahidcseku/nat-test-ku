...
function computeRegNo($siteCode, $levelName, $sheetRow) {
    $levelDigit = substr($levelName, 0, 1); // "1Q/N1" -> "1"
...
// =====================================================================
$LEVELS    = ['1Q/N1', '2Q/N2', '3Q/N3', '4Q/N4', '5Q/N5'];
...
$assigned = ['1Q/N1' => [], '2Q/N2' => [], '3Q/N3' => [], '4Q/N4' => [], '5Q/N5' => []];
...
try {
    ...
    $newByLevel = ['1Q/N1' => [], '2Q/N2' => [], '3Q/N3' => [], '4Q/N4' => [], '5Q/N5' => []];
    foreach ($registrations as $r) {
