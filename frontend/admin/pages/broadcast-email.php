...
<?php if ($view === 'preview'): ?>
    ...
    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
        <form method="POST" action="<?php echo BASE_URL; ?>/api/broadcast-email/send.php" style="flex: 0;" onsubmit="var b=this.querySelector('button[type=submit]'); if(b) b.disabled=true;">
